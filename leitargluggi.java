 ...
 * @author Dottedsocks
 */
public class leitargluggi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFromWhere = new javax.swing.JTextField();
        jToWhere = new javax.swing.JTextField();
        jWhen = new javax.swing.JTextField();
        searchButton = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jFromWhere.setText("Hvert");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(leitargluggi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new leitargluggi().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField jFromWhere;
    private javax.swing.JTextField jToWhere;
